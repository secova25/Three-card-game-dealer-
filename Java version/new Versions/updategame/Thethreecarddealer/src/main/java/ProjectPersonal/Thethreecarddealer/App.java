...
public class App extends Application {
    ...
    //----------------------Game One-------------------------------------------------------------------
    //this method will play the Probability game. 
    ...
    public void GamePlay2(Stage stage) {
    	Label a1 = new Label( "Welcome players to Nim Type Zero.");
		Label a2 = new Label ("Before we begin,let me your dealer, explain the rules.");
		Label a3 = new Label("You will each be dealt four cards, from a deck of 40 cards.");
		Label a4 = new Label("The object of this game is to be the player who does not go over 9.");
		Label a5 = new Label("Any players who go over 9 will not recieve a point.");
		Label a6 = new Label ("There will be three rounds and at the end of the third round the winnner will be anounced.");
		Label a7 = new Label("Since I am unable to see you, I must warn all players...");
		Label a8 = new Label("ANY CHEATING WILL AUTOMATICLY END THE GAME!!!");
		Label a9 = new Label( "Lets us begin the game.");
		Label a10 = new Label("Press the Start Button to begin the game.");
		Label a11 = new Label("Press the Home Button to play a different game.");
		Label a12 = new Label("Press the Exit Button to Exit the game.");
		Label a13 = new Label();
		
		//creating the buttons and the event on action.
		Button start = new Button("Start");
		Button end = new Button("Exit");
		Button home = new Button("Home");
		HBox  x = new HBox(home,start,end);
		
		VBox ax = new VBox(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12,a13,x);
		
		//making the third borderPane for results.
		BorderPane t = new BorderPane();
		t.setCenter(ax);
		Scene th = new Scene(t, 1000,1000);
		stage.setScene(th);
		stage.show();
    ...
    //-------------------------End of Game Two------------------------------------------------------
    //--------------------------Game Three----------------------------------------------------------
    //This method will allow us to play Card Guess game. 
